 ...
 */
        function(e) {
            ...
            function v(e, t, n, r, o, s) {
                return r && !r[M] && (r = v(r)), o && !o[M] && (o = v(o, s)), i(function(i, s, a, u) {
                    var c, l, f, d = [], v = [], g = s.length, m = i || h(t || "*", a.nodeType ? [ a ] : a, []), y = !e || !i && t ? m : p(m, d, e, a, u), b = n ? o || (i ? e : g || r) ? [] : s : y;
                    if (n && n(y, b, a, u), r) for (c = p(b, v), r(c, [], a, u), l = c.length; l--; ) (f = c[l]) && (b[v[l]] = !(y[v[l]] = f));
                    if (i) {
                        if (o || e) {
                            if (o) {
            ...
            function m(e, n) {
                var r = n.length > 0, o = e.length > 0, s = function(i, s, a, u, c) {
                    var l, f, d, h = 0, v = "0", g = i && [], m = [], y = C, b = i || o && x.find.TAG("*", c), w = R += null == y ? 1 : Math.random() || .1, _ = b.length;
        ...
        te.Callbacks = function(e) {
            var t, n, i, r, o, s, a = [], u = !(e = "string" == typeof e ? ve[e] || c(e) : te.extend({}, e)).once && [], l = function(c) {
        ...
        te.extend({
            ...
            ajax: function(e, t) {
                ...
                var i, r, o, s, a, u, c, l, f = te.ajaxSetup({}, t), d = f.context || f, h = f.context && (d.nodeType || d.jquery) ? te(d) : te.event, p = te.Deferred(), v = te.Callbacks("once memory"), g = f.statusCode || {}, m = {}, y = {}, b = 0, x = "canceled", w = {
                    readyState: 0,
    ...
    function u(e, t) {
        ...
        if (t.singleton) {
            var u = m++;
            n = g || (g = s(t)), i = c.bind(null, n, u, !1), r = c.bind(null, n, u, !0);
    ...
    d.nextTick = function(e) {
        ...
        p.push(new u(e, t)), 1 !== p.length || v || r(a);
    ...
    var i = n(1), r = n(9), o = n(36), s = n(38), a = n(11), u = function(e, t, n) {
        var c, l, f, d, h = e & u.F, p = e & u.G, v = e & u.S, g = e & u.P, m = e & u.B, y = p ? i : v ? i[t] || (i[t] = {}) : (i[t] || {}).prototype, b = p ? r : r[t] || (r[t] = {}), x = b.prototype || (b.prototype = {});
        p && (n = t);
        for (c in n) f = ((l = !h && y && void 0 !== y[c]) ? y : n)[c], d = m && l ? a(f, i) : g && "function" == typeof f ? a(Function.call, f) : f, 
    ...
    var i, r, o, s = n(11), a = n(77), u = n(78), c = n(37), l = n(1), f = l.process, d = l.setImmediate, h = l.clearImmediate, p = l.MessageChannel, v = l.Dispatch, g = 0, m = {}, y = function() {
        var e = +this;
    ...
    "use strict";
    function i() {
        var e = "fixed" === a()(".js-site-header").css("position") || a()(".js-fixed-nav").length;
        h.a.theme && ("marta" === h.a.theme.name || "lukas" === h.a.theme.name) && e && a()(window).on("scroll", function() {
            return E.a.setClass("on-scroll", ".js-site-header");
        });
    }
    function r() {
        A.a.hasTouch() && (a()(document.body).addClass("has-touch"), a()(".js-project-cover-touch").on("touchstart", function(e) {
            var t = e.currentTarget, n = a()(t);
    ...
    function o() {
        Object($.a)() && Object($.b)() < 11.2 && a()(function() {
            a()(".mp4-image").css("display", "none"), a()(".renditions-video").css("display", "block");
        });
    }
    Object.defineProperty(t, "__esModule", {
        value: !0
    }), t.navScroll = i, t.addTouchSupportToProjectCovers = r, t.checkLegacySafari = o;
    var s = n(0), a = n.n(s), u = n(55), c = (n.n(u), n(69)), l = (n.n(c), n(86)), f = n(101), d = n(14), h = n.n(d), p = n(102), v = n(105), g = n(108), m = n(109), y = n(24), b = n(110), x = n(113), w = n(117), _ = n(118), k = n(119), T = n(50), A = n(120), C = n(121), j = n(122), S = n(129), E = n(132), N = n(133), O = n(52), D = n(135), F = n(136), L = n(138), P = (n.n(L), 
    n(140)), $ = (n.n(P), n(142));
    if (r(), w.a.init(), m.a.init(), p.a.init(), v.a.init(), i(), Object(g.a)(), x.a.init(), 
    Object(D.a)(), o(), !Object(T.a)()) {
        y.a.init();
        var M = a()(".js-project-module-form");
        M.length && j.a.init(M);
    }
    h.a.lightbox && h.a.lightbox.enabled && l.a.init(h.a.lightbox), h.a.cookie_banner && h.a.cookie_banner.enabled ? N.a.init(h.a.cookie_banner, h.a.googleAnalytics) : h.a.googleAnalytics && O.a.init(h.a.googleAnalytics), 
    h.a.pageTransition && b.a.init(), h.a.linkTransition && a()(document.body).addClass("link-transition"), 
    h.a.disableDownload && _.a.init(), Object(f.a)() || a()(".grid__item-container, .logo.has-rollover, .logo-secondary.has-rollover").addClass("hoverable"), 
    a()("html, body").on("click", ".js-masthead-arrow", function() {
        var e = 0, t = ".js-site-wrap", n = a()(".js-fixed-nav");
        if (n.length) {
            var i = '[data-context="page.gallery.covers"] .js-project-cover-touch';
            a()(i).length && (t = i), e = n.height();
        }
        Object(C.a)(t, e);
    }), a()(".js-masthead-fixed").length && a()(window).on("scroll", function() {
        return Object(k.a)(".js-masthead-fixed", ".js-masthead-text");
    }), S.a.init(a()(".js-project-cover")), Object(F.a)();
}, function(e, t, n) {
    var i = n(35);
    i(i.S + i.F, "Object", {
        assign: n(59)
    ...
    e.exports = !u || n(21)(function() {
        ...
        for (var n = s(e), u = arguments.length, c = 1, l = r.f, f = o.f; u > c; ) for (var d, h = a(arguments[c++]), p = l ? i(h).concat(l(h)) : i(h), v = p.length, g = 0; v > g; ) f.call(h, d = p[g++]) && (n[d] = h[d]);
        return n;
    } : u;
}, function(e, t, n) {
    var i = n(61), r = n(65);
    ...
    "use strict";
    var i, r, o, s, a = n(70), u = n(1), c = n(11), l = n(45), f = n(35), d = n(8), h = n(12), p = n(71), v = n(72), g = n(76), m = n(47).set, y = n(79)(), b = n(48), x = n(80), w = n(81), _ = u.TypeError, k = u.process, T = u.Promise, A = "process" == l(k), C = function() {}, j = r = b.f, S = !!function() {
        try {
        ...
        m.call(u, function() {
            ...
            if (o && (t = x(function() {
                A ? k.emit("unhandledRejection", r, e) : (n = u.onunhandledrejection) ? n({
                    promise: e,
                    reason: r
    ...
    (t = e.exports = function(e, t, n, f, d) {
        ...
        } else for (v = m.call(e); !(p = v.next()).done; ) if ((g = r(v, y, p.value, t)) === c || g === l) return g;
    }).BREAK = c, t.RETURN = l;
}, function(e, t, n) {
    var i = n(7);
    ...
    var s = n(49), a = (n.n(s), n(0)), u = n.n(a), c = n(93), l = n.n(c), f = n(94), d = n.n(f), h = n(95), p = n.n(h), v = n(96), g = n(99), m = n(100), y = function() {
        function e(t, n, r) {
            i(this, e), this._$context = t, this._controller = n, this._props = r, this._$view = u()(v.a).appendTo(t), 
    ...
    !function(r) {
        ...
        o.prototype = {
            ...
            toHslString: function() {
                var e = u(this._r, this._g, this._b), t = W(360 * e.h), n = W(100 * e.s), i = W(100 * e.l);
 ...
 */
    ...
    t.a = {
        ...
        init: function(e) {
            var t = this;
            e.each(function(e, n) {
                for (var r = u()(n), o = r.find("form"), s = r.data("id"), a = r.find(".js-submit"), c = a.find(".js-submit-text"), f = new y.a(t._spinnerOpts), h = Object.entries(d.a.localizedValidationMessages), v = 0; v < h.length; v++) {
                    var m = i(h[v], 2), b = m[0], w = m[1];
